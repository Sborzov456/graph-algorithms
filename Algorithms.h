...
//DFS
int DFS(vertex* startVertex, vertex* previousVertex, int finishVertexKey); //the process of finding a way
...
int headspring(graph* graph, vertex* vertex); // returns 1 if vertex is headspring and -1 if not
